...
void read_weight(int **Weight, float **Bias, float **BN_G, float **BN_B, float **BN_RM, float **BN_RV)
{
    FILE *fp1 = fopen("./Weight/conv2d_3x3x3x128.txt", "r");
    FILE *fp2 = fopen("./Weight/conv2d_3x3x128x128.txt", "r");
    FILE *fp3 = fopen("./Weight/conv2d_3x3x128x256.txt", "r");
    FILE *fp4 = fopen("./Weight/conv2d_3x3x256x256.txt", "r");
    FILE *fp5 = fopen("./Weight/conv2d_3x3x256x512.txt", "r");
    FILE *fp6 = fopen("./Weight/conv2d_3x3x512x512.txt", "r");
    FILE *fp7 = fopen("./Weight/fc_8192x1024.txt", "r");
    FILE *fp8 = fopen("./Weight/fc_1024x1024.txt", "r");
    FILE *fp9 = fopen("./Weight/fc_1024x10.txt", "r");

    FILE *fp10 = fopen("./Weight/bias_conv2d_3x3x3x128.txt", "r");
    FILE *fp11 = fopen("./Weight/bias_conv2d_3x3x128x128.txt", "r");
    FILE *fp12 = fopen("./Weight/bias_conv2d_3x3x128x256.txt", "r");
    FILE *fp13 = fopen("./Weight/bias_conv2d_3x3x256x256.txt", "r");
    FILE *fp14 = fopen("./Weight/bias_conv2d_3x3x256x512.txt", "r");
    FILE *fp15 = fopen("./Weight/bias_conv2d_3x3x512x512.txt", "r");
    FILE *fp16 = fopen("./Weight/bias_fc_8192x1024.txt", "r");
    FILE *fp17 = fopen("./Weight/bias_fc_1024x1024.txt", "r");
    FILE *fp18 = fopen("./Weight/bias_fc_1024x10.txt", "r");

    FILE *fp19 = fopen("./Weight/bn_1_gamma.txt", "r");
    FILE *fp20 = fopen("./Weight/bn_1_beta.txt", "r");
    FILE *fp21 = fopen("./Weight/bn_1_running_mean.txt", "r");
    FILE *fp22 = fopen("./Weight/bn_1_running_var.txt", "r");
    FILE *fp23 = fopen("./Weight/bn_2_gamma.txt", "r");
    FILE *fp24 = fopen("./Weight/bn_2_beta.txt", "r");
    FILE *fp25 = fopen("./Weight/bn_2_running_mean.txt", "r");
    FILE *fp26 = fopen("./Weight/bn_2_running_var.txt", "r");
    FILE *fp27 = fopen("./Weight/bn_3_gamma.txt", "r");
    FILE *fp28 = fopen("./Weight/bn_3_beta.txt", "r");
    FILE *fp29 = fopen("./Weight/bn_3_running_mean.txt", "r");
    FILE *fp30 = fopen("./Weight/bn_3_running_var.txt", "r");
    FILE *fp31 = fopen("./Weight/bn_4_gamma.txt", "r");
    FILE *fp32 = fopen("./Weight/bn_4_beta.txt", "r");
    FILE *fp33 = fopen("./Weight/bn_4_running_mean.txt", "r");
    FILE *fp34 = fopen("./Weight/bn_4_running_var.txt", "r");
    FILE *fp35 = fopen("./Weight/bn_5_gamma.txt", "r");
    FILE *fp36 = fopen("./Weight/bn_5_beta.txt", "r");
    FILE *fp37 = fopen("./Weight/bn_5_running_mean.txt", "r");
    FILE *fp38 = fopen("./Weight/bn_5_running_var.txt", "r");
    FILE *fp39 = fopen("./Weight/bn_6_gamma.txt", "r");
    FILE *fp40 = fopen("./Weight/bn_6_beta.txt", "r");
    FILE *fp41 = fopen("./Weight/bn_6_running_mean.txt", "r");
    FILE *fp42 = fopen("./Weight/bn_6_running_var.txt", "r");
    FILE *fp43 = fopen("./Weight/bn_7_gamma.txt", "r");
    FILE *fp44 = fopen("./Weight/bn_7_beta.txt", "r");
    FILE *fp45 = fopen("./Weight/bn_7_running_mean.txt", "r");
    FILE *fp46 = fopen("./Weight/bn_7_running_var.txt", "r");
    FILE *fp47 = fopen("./Weight/bn_8_gamma.txt", "r");
    FILE *fp48 = fopen("./Weight/bn_8_beta.txt", "r");
    FILE *fp49 = fopen("./Weight/bn_8_running_mean.txt", "r");
    FILE *fp50 = fopen("./Weight/bn_8_running_var.txt", "r");
    FILE *fp51 = fopen("./Weight/bn_9_gamma.txt", "r");
    FILE *fp52 = fopen("./Weight/bn_9_beta.txt", "r");
    FILE *fp53 = fopen("./Weight/bn_9_running_mean.txt", "r");
    FILE *fp54 = fopen("./Weight/bn_9_running_var.txt", "r");
